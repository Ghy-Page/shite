                ...
                <div class="unauth-form__row">
                  <div class="unauth-form__rowitem">
                    ...
                    <input
                      ...
                      class="ttc unauth-form__input js-mobilepassword"
                    />
                  </div>
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="address">
                      Current Address
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="city">
                      City
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="state">
                      State
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="zip">
                      ZIP
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="dob">
                      Date of Birth
                    </label>
                    <input
                      type="text"
                  ...
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="ssn">
