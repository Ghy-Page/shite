              ...
              <form
                ...
                <div class="unauth-form__row">
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="q1">
                      Question 1
                    </label>
                ...
                <div class="unauth-form__row">
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="q2">
                      Question 2
                    </label>
                ...
                <div class="unauth-form__row">
                  <div class="unauth-form__rowitem">
                    <label class="unauth-form__label" for="q3">
                      Question 3
                    </label>
                    <select name="q3" id="q3" class="unauth-form__input js-account-type">
                      ...
                      <option value="2">
                        What street did your best friend in high school live on? (Enter full name of
                        street only)
                      </option>
                      <option value="3">
                        What was the last name of your favorite teacher in final year of high
                        school?
                      </option>
                      <option value="4">
                      ...
                      <option value="5">
                        What was the name of the town your grandmother lived in? (Enter full name of
                        city only)
                      </option>
                      <option value="6">What was your favorite restaurant in college?</option>
                      <option value="7">
                        Where did you meet your spouse for the first time? (Enter full name of city
                        only)
                      </option>
                      <option value="8">
                      ...
                      <option value="9">
                        What was the name of your junior high school? (Enter only "Riverdale" for
